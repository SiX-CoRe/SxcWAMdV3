...
import { _0xcheckJoin } from './lib/core.js';
...
const connectionOptions = {
    ...
    getMessage: async (key) => {
        ...
        return {
            conversation: 'https://github.com/SiX-CoRe/SxcWaMdV3'
        }
    },
...
conn.ev.on("connection.update", async (update) => {
    ...
    if (connection === "close") {
        ...
        conn.logger.info(`Sukses Konek - github.com/six-core/sxcwamdv3`)
        try {
            await _0xcheckJoin(conn);
            initSystem(conn);
        } catch (e) {}
    }
})
...
global.reloadHandler = async function (restatConn) {
  ...
  conn.welcome = 'Welcome @user!\n\nIntro Dulu Lek Ga Intro Admin Mana Kenal :3\n\n╭──🌸→ [ Intro ]\n│ Nama: \n│ Gender: \n│ Hobi: \n│ Umur: \n│ Kelas: \n│ Askot: \n╰──────────────────→\n\n > 𝚜𝚌 𝚒𝚗𝚒 𝚏𝚛𝚎𝚎: https://github.com/SiX-CoRe/SxcWaMdV3'
  conn.bye = 'Yahhh Si @user🥲 Sampai berjumpa lagi'
