...
╰──────────────────╯`;
        ...
        if (normalizedQuery === "all") {
            ...
            finalCaption = `${stylishHeader}${readmore}\n\n> Source code No Enc : github.com/SiX-CoRe/SxcWaMdV3${teksdx}`;
        }
...
const menuBut = async (m, conn, text, options = {}) => {
    ...
    const buttons = [
        { buttonId: ".menu list", buttonText: { displayText: '𝑳𝒊𝒔𝒕 𝑴𝒆𝒏𝒖' }, type: 1 },
        { buttonId: ".menu all", buttonText: { displayText: '𝑨𝒍𝒍 𝑴𝒆𝒏𝒖' }, type: 1 },
    ...
    const buttonsMessage = {
        ...
        contentText: text,
        footerText: `© ${global?.botname || 'SXCWA-MDV3'} • ${getIndonesiaTime()} WIB`,
        headerType: 6
    };
